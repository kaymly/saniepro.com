...
return [
    ...
    'excluded' => [
        ...
        'enhanced-checkout-woocommerce' => [
            // the Enhanced Checkout plugin should only be available on US sites
            'countriesNotIn' => [
                'US',
            ],
        ],
    ...
    'categories' => [
        ...
        'enhanced-checkout-woocommerce'               => 'Cart and Checkout',
    ],

    /*
     * List of extensions data to override default data, keyed by slug. Override data will merge into default extension data.
     * Example:
     *   'some-extension-slug' => ['documentationUrl' => 'https://help.example.com/']
     */
    'overrides' => [],
];
