	...
	protected function register_controls() {
        ...
        // Start Content        
			...
			$this->add_control(
				...
				[
					...
					'default' => esc_html__( 'FINANCIAL PROJECTIONS AND ANALYSIS', 'themesflat-elementor' ),
				]
			); 
        ...
        // Start Content Style        
	        ...
	        $this->add_control(
				...
				[
					...
					'default' => 'style-1',
					'options' => [
						'style-1' => esc_html__( 'Default', 'themesflat-elementor' ),
						'style-2' => esc_html__( 'Content Absolute (Full)', 'themesflat-elementor' ),
						'style-3' => esc_html__( 'Content Absolute (Only Title)', 'themesflat-elementor' )
					],
				]
			);   
			...
			$this->add_control(
				'content_effect',
				[
					'label' => esc_html__( 'Effect', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'fade-in',
					'options' => [
						'fade-in' => esc_html__( 'Fade In', 'themesflat-elementor' ),
			...
			$this->add_control( 
				'heading_title_show',
				[
					'label' => esc_html__( 'Title Show', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
			...
			$this->add_control( 
				...
				[
					'label' => esc_html__( 'Icon Title Show', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'condition' => [
						'content_style' => 'style-3'
					]
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Gradient Color', 'themesflat-elementor' ),
					'types' => [ 'gradient' ],
					'fields_options' => [
						'gradient_type' => [
							'default' => 'linear'
	    ...
	    // Start Button Style 
			...
			$this->add_control(
				'button_display',
				[
					'label' => esc_html__( 'Button Display', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'unset',
					'options' => [
						'unset' => esc_html__( 'Default', 'themesflat-elementor' ),
						'absolute' => esc_html__( 'Absolute', 'themesflat-elementor' ),
					],
					'selectors' => [
						'{{WRAPPER}} .tf-imagebox .tf-button' => 'position: {{WRAPPER}}',
					],
				]
			); 

			$this->add_control(
				'button_align_position',
				[
					'label' => esc_html__( 'Alignment', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::CHOOSE,
					'options' => [
					...
					'default' => 'right',
					'selectors' => [
						'{{WRAPPER}} .tf-imagebox .tf-button' => '{{WRAPPER}}:0;',
					],
					'condition' => [
						'button_display' => 'absolute'
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'vw', 'vh' ],
					'selectors' => [
						'{{WRAPPER}} .tf-imagebox .tf-button' => 'left: {{SIZE}}{{UNIT}}',
					],
					'condition' => [
						'button_align_position' => 'left',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'vw', 'vh' ],
					'selectors' => [
						'{{WRAPPER}} .tf-imagebox .tf-button' => 'right: {{SIZE}}{{UNIT}}',
					],
					'condition' => [
						'button_align_position' => 'right',
					],
				]
			);

			$this->add_control(
				'button_horizon_position',
				[
					'label' => esc_html__( 'Alignment', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::CHOOSE,
					'options' => [
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'vw', 'vh' ],
					'selectors' => [
						'{{WRAPPER}} .tf-imagebox .tf-button' => 'top: {{SIZE}}{{UNIT}}',
					],
					'condition' => [
						'button_horizon_position' => 'top',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'vw', 'vh' ],
					'selectors' => [
						'{{WRAPPER}} .tf-imagebox .tf-button' => 'bottom: {{SIZE}}{{UNIT}}',
					],
					'condition' => [
						'button_horizon_position' => 'bottom',
					],
				]
			);
