...
class TFAccordion_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Accordion', 'tf-addon-for-elementer' );
    }
	...
	protected function register_controls() {
        // Start Accordion        
			$this->start_controls_section( 
				'section_accordion',
	            [
	                'label' => esc_html__('Accordion', 'tf-addon-for-elementer'),
	            ]
	        );	
			...
			$this->add_control( 
				...
				[
					...
					'default' => 'icon_after',
					'options' => [
						'icon_before'  => esc_html__( 'Left', 'tf-addon-for-elementer' ),
						'icon_after' => esc_html__( 'Right', 'tf-addon-for-elementer' ),
						'icon_before_after' => esc_html__( 'Both side', 'tf-addon-for-elementer' ),
					],
					'condition' => [
						'icon_style!' => 'none',
					],
			...
			$this->add_control( 'icon_accodion',
				[
					'label' => esc_html__( 'Left Icon', 'tf-addon-for-elementer' ),
			...
			$this->add_control( 'image_accodion',
				[
					'label' => esc_html__( 'Left Icon Image', 'tf-addon-for-elementer' ),
			...
			$this->add_control( 'icon_accodion_active',
				[
					'label' => esc_html__( 'Left Icon Active', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_active',
				[
					'label' => esc_html__( 'Left Icon Image Active', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
			...
			$this->add_control( 'icon_accodion_right',
				[
					'label' => esc_html__( 'Right Icon', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_right',
				[
					'label' => esc_html__( 'Right Icon Image', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
			...
			$this->add_control( 'icon_accodion_right_active',
				[
					'label' => esc_html__( 'Right Icon Active', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_right_active',
				[
					'label' => esc_html__( 'Right Icon Image Active', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
	        ...
	        $repeater = new \Elementor\Repeater();
	        	$repeater->add_control( 'set_active',
					[
						'label' => esc_html__( 'Set Active Item', 'tf-addon-for-elementer' ),
		        ...
		        $repeater->add_control( 'list_title', [
						'label' => esc_html__( 'Nav text', 'tf-addon-for-elementer' ),
						'type' => \Elementor\Controls_Manager::TEXT,
						'default' => esc_html__( 'Accordion' , 'tf-addon-for-elementer' ),
						'label_block' => true,
					]
				);
				...
				$repeater->add_control( 'list_content_text_type',
					[
						...
						'default' => 'editor',
						'options' => [
							'editor'  => esc_html__( 'Editor', 'tf-addon-for-elementer' ),
				...
				$repeater->add_control( 'list_content', [
						...
						'default' => esc_html__( 'Good strategy is the antidote to competition. Strategic thinking is the process of developing a strategy that defines your value proposition and your unique value chain. This process includes market and competitive research as well as an assessment of the company’s capabilities and the industry forces impacting it.' , 'tf-addon-for-elementer' ),
						'label_block' => true,
						'condition' => [
				...
				$repeater->add_control( 'list_content_template',
					[
						'label' => esc_html__( 'Choose Template', 'tf-addon-for-elementer' ),
						'type' => \Elementor\Controls_Manager::SELECT,
		        ...
		        $this->add_control( 'accordion_list',
					[					
						...
						'default' => [
							[	
								'set_active' => 'active',
								'list_title' => esc_html__( '01. What does you do?', 'tf-addon-for-elementer' ),
							...
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '02. What is graphics design?', 'tf-addon-for-elementer' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '03. Why we are the best?', 'tf-addon-for-elementer' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '04. What is industries covered?', 'tf-addon-for-elementer' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '05. What is graphics design?', 'tf-addon-for-elementer' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
						],
        ...
        // Start Icon Style 
	        ...
	        $this->add_responsive_control(
				'icon_size_w',
				[
					'label' => esc_html__( 'Icon Size Width', 'tf-addon-for-elementer' ),
			...
			$this->add_responsive_control(
				'icon_size_h',
				[
					'label' => esc_html__( 'Icon Size Height', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px', '%' ],
					'range' => [
						'px' => [
	        ...
	        $this->add_control(
				'heading_icon_left',
				[
					'label' => esc_html__( 'Icon Left', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'icon_position' => ['icon_before', 'icon_before_after'],
			...
			$this->add_control(
				'heading_icon_right',
				[
					'label' => esc_html__( 'Icon Right', 'tf-addon-for-elementer' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'icon_position' => ['icon_after', 'icon_before_after'],
		...
		foreach ($settings['accordion_list'] as $key => $value) {
			...
			if ( $settings['icon_style'] == 'icon' ) {
				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_close =  \Elementor\Addon_Elementor_Icon_manager_janelas::render_icon( $settings['icon_accodion'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_close =  \Elementor\Addon_Elementor_Icon_manager_janelas::render_icon( $settings['icon_accodion_right'] );
				}

				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_open =  \Elementor\Addon_Elementor_Icon_manager_janelas::render_icon( $settings['icon_accodion_active'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_open =  \Elementor\Addon_Elementor_Icon_manager_janelas::render_icon( $settings['icon_accodion_right_active'] );
				}
