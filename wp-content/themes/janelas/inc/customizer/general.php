...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Smooth Scroll ( OFF | ON )', 'janelas'),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Preload ( OFF | ON )', 'janelas'),
        'section' => 'general_panel',
        'priority' => 2,
    ))
);
...
$wp_customize->add_control( new themesflat_RadioImages($wp_customize,
    ...
    array (
        ...
        'section'   => 'general_panel',
        'priority'  => 3,
        'label'         => esc_html__('Preload', 'janelas'),
        'choices'   => array (
            'preload-1' => array (
                'tooltip'   => esc_html__( 'Circle Loaders 1','janelas' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-1.png'
            ) ,
            'preload-2'=>  array (
                'tooltip'   => esc_html__( 'Circle Loaders 2','janelas' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-2.png'
            ) ,
            'preload-3'=>  array (
                'tooltip'   => esc_html__( 'Circle Loaders 3','janelas' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-3.png'
            ) ,
            'preload-4'=>  array (
                'tooltip'   => esc_html__( 'Circle Loaders 4','janelas' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-4.png'
            ) ,
            'preload-5'=>  array (
                'tooltip'   => esc_html__( 'Spinner Loaders','janelas' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-5.png'
            ) ,
            'preload-6'=>  array (
                'tooltip'   => esc_html__( 'Pulse Loaders','janelas' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-6.png'
            ) ,
            'preload-7'=>  array (
                'tooltip'   => esc_html__( 'Square Loaders','janelas' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-7.png'
            ) ,
            'preload-8'=>  array (
                'tooltip'   => esc_html__( 'Line Loaders','janelas' ),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Social Share  ( OFF | ON )', 'janelas'),
        'description'   => esc_html__('Social share only visible on detail pages', 'janelas'),
        'section' => 'general_panel',
        'priority' => 6,
    ))
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Go To Button ( OFF | ON )', 'janelas'),
        'section' => 'general_panel',
        'priority' => 8,
    ))
);
