	...
	protected function register_controls() {
        // Start Menu Settings        
	        ...
	        $this->add_control(
            	'one_page_enable',
	            [
					'label' => esc_html__('Enable one page?', 'themesflat-elementor'),
					'description'	=> esc_html__('This works in the current page.', 'themesflat-elementor'),
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'only-icon' => esc_html__( 'Only Icon', 'themesflat-elementor' ),
					],
				]
			);
			...
			$this->add_control(
				'menu_panel_style',
				[
					'label' => esc_html__( 'Menu Panel Style', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'menu-panel-style-default',
					'options' => [
						'menu-panel-style-default'  => esc_html__( 'Default', 'themesflat-elementor' ),
						'menu-panel-style-left' => esc_html__( 'Left', 'themesflat-elementor' ),
					],
				]
			);
			...
			$this->add_control(
				'main_menu_position',
				[
					'label' => esc_html__( 'Alignment Menu', 'themesflat-elementor' ),
			...
			$this->add_control(
				'heading_responsive',
				[
					'label' => esc_html__( 'Responsive', 'themesflat-elementor' ),
	        ...
	        $this->add_control(
				'nav_menu_logo',
				[
					'label' => esc_html__( 'Choose Mobile Menu Logo', 'themesflat-elementor' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Link Logo', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'home',
					'options' => [
						'home' => esc_html__( 'Home', 'themesflat-elementor' ),
						'custom' => esc_html__( 'Custom URL', 'themesflat-elementor' ),
					],
					'condition' => [
						'nav_menu_logo[url]!' => '',
					],
			...
			$this->add_control(
				'nav_menu_logo_link',
				[
					'label' => esc_html__( 'URL', 'themesflat-elementor' ),
			...
			$this->add_control(
				...
				[			        
			        'label' => esc_html__('Icon Button Menu Mobile & Only Icon', 'themesflat-elementor'),
			...
			$this->add_control(
				'btn_menu_close',
				[			        
			        'label' => esc_html__('Icon Close Menu', 'themesflat-elementor'),
			        'type' => \Elementor\Controls_Manager::ICONS,
			        'default' => [
			            'value' => 'fas fa-times',
			            'library' => 'fa-solid',
        ...
        // Start Main Menu Style 
	        $this->start_controls_section( 
	        	'section_style_menu',
	            [
	                'label' => esc_html__( 'Main Menu', 'themesflat-elementor' ),
	        ...
	        $this->add_control(
				...
				[
					'label' => esc_html__( 'Horizontal Padding', 'themesflat-elementor' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Vertical Padding', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
			...
			$this->add_control(
				'link_hover_effect',
				[
					'label' => esc_html__( 'Link Hover Effect', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'none',
					'options' => [
						'none'  => esc_html__( 'None', 'themesflat-elementor' ),
						'underline' => esc_html__( 'Underline', 'themesflat-elementor' ),
						'overline' => esc_html__( 'Overline', 'themesflat-elementor' ),
						'double-line' => esc_html__( 'Double Line', 'themesflat-elementor' ),
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'drop-in' => esc_html__( 'Drop In', 'themesflat-elementor' ),
						'drop-out' => esc_html__( 'Drop Out', 'themesflat-elementor' ),						
					],
					'condition' => [
			...
			$this->add_control(
				'submenu_icon_margin',
				[
					'label' => esc_html__( 'Submenu Icon Margin', 'themesflat-elementor' ),
	    ...
	    // Start Dropdown Style 
	        $this->start_controls_section( 
	            ...
	            [
	                'label' => esc_html__( 'Dropdown', 'themesflat-elementor' ),
	                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
	            ]
	        );
			...
			$this->add_responsive_control(
				'item_submenu_width',
				[
					'label' => esc_html__( 'Dropdown Width', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Top Distance', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px', '%' ],
					'range' => [
						'px' => [
			...
			$this->add_control(
				...
				[
					'label'       => esc_html__( 'Border Style', 'themesflat-elementor' ),
					'type'        => \Elementor\Controls_Manager::SELECT,
					'default'     => 'none',
					'label_block' => false,
					'options'     => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Border First Child', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Border Last Child', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
	    ...
	    // Start Mobile Button & Close Icon Style 
	        $this->start_controls_section( 
	            ...
	            [
	                'label' => esc_html__( 'Mobile Button & Close Icon', 'themesflat-elementor' ),
	                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
	            ]
	        );
	        ...
	        $this->add_control(
				...
				[
					'label' => esc_html__( 'Button Close', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
	    ...
	    // Start Menu Panel Style 
	        $this->start_controls_section( 
	            ...
	            [
	                'label' => esc_html__( 'Menu Panel', 'themesflat-elementor' ),
	                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
	            ]
	        );
	        ...
	        $this->add_control(
				'heading_panel_logo',
				[
					'label' => esc_html__( 'Logo', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Border Menu', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				'heading_panel_menu',
				[
					'label' => esc_html__( 'Menu', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);			
			...
			$this->start_controls_tabs( 'panel_menu_tabs' );				
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Horizontal Padding Link (px)', 'themesflat-elementor' ),
						'type'      => \Elementor\Controls_Manager::SLIDER,
						'separator' => 'before',
						'range'     => [
							'px' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Vertical Padding Link (px)', 'themesflat-elementor' ),
						'type'      => \Elementor\Controls_Manager::SLIDER,
						'range'     => [
							'px' => [
								'max' => 200,
				...
				$this->add_control(
					'width_icon_submenu',
					[
						'label'     => esc_html__( 'Width Icon Submenu (px)', 'themesflat-elementor' ),
						'type'      => \Elementor\Controls_Manager::SLIDER,						
						'range'     => [
							'px' => [
								'max' => 200,
				...
				$this->add_control(
					'height_icon_submenu',
					[
						'label'     => esc_html__( 'Height Icon Submenu (px)', 'themesflat-elementor' ),
						'type'      => \Elementor\Controls_Manager::SLIDER,						
						'range'     => [
							'px' => [
								'max' => 200,
