...
function themesflat_setup() {
     ...
     * to change 'janelas' to the name of your theme in all the template files
     */
    load_theme_textdomain( 'janelas', THEMESFLAT_DIR . '/languages' );
    ...
    register_nav_menus( array(
        'primary' => esc_html__( 'Primary Menu', 'janelas' )
    ) );
...
function themesflat_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Blog', 'janelas' ),
        'id'            => 'blog-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Blog Sidebar.', 'janelas' ),
    ...
    //Widget footer
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 1', 'janelas' ),
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 1.', 'janelas' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 2', 'janelas' ),
        'id'            => 'footer-2',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 2.', 'janelas' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 3', 'janelas' ),
        'id'            => 'footer-3',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 3.', 'janelas' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 4', 'janelas' ),
        'id'            => 'footer-4',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer widget area 4.', 'janelas' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Toggler', 'janelas' ),
        'id'            => 'aside-toggler-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar toggler.', 'janelas' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Shop', 'janelas' ),
        'id'            => 'shop-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar toggler.', 'janelas' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Services Sidebar', 'janelas' ),
...
function themesflat_scripts() {    
    // Theme stylesheet.    
    wp_enqueue_style( 'icon-janelas', THEMESFLAT_LINK . 'css/icon-janelas.css' );
    ...
    wp_register_style('font-awesome-5-14-0', THEMESFLAT_LINK . 'css/font-awesome-5.14.0.css');
    wp_enqueue_style( 'font-awesome-5-14-0' );
...
// fix render p in contact form 7
