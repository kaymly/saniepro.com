...
<header id="header" class="header header-style4 <?php echo themesflat_get_opt_elementor('extra_classes_header'); ?>">
                    ...
                    <div class="header-wrap clearfix">
                        ...
                        <div class="header-ct-right">
                            ...
                            <div class="wrap-btn-header draw-border">
                                <a class="btn-header" href="<?php echo esc_url(themesflat_get_opt('header_button_url')) ?>"><?php echo themesflat_get_opt('header_button_text'); ?><i class="janelas-icon-long-arrow-right2" aria-hidden="true"></i></a> 
                            </div>
                            <?php endif;?>
