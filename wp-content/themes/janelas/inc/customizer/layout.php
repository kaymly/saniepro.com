...
$wp_customize->add_control( 
    ...
    array(
        ...
        'priority'  => 1,
        'label'         => esc_html__('Layout version', 'janelas'),
        'choices'   => array(
            'wide'           =>  esc_html__('Wide','janelas'),
            'boxed'         =>   esc_html__('Boxed','janelas'),
    ))
);  
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'body_background_color',
        array(
            'label'         => esc_html__('Body Background Color', 'janelas'),
            'section'       => 'background_image',
            'priority'      => 2
        )
    )
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'content_controls',
    array(
        'label' => esc_html__( 'Content Box Controls (px)', 'janelas' ),
        'section' => 'background_image',
        'type' => 'box-controls',
        'priority' => 10
    ))
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'section'   => 'background_image',
        'priority'  => 11,
        'label'         => esc_html__('Page Sidebar Position', 'janelas'),
        'choices'   => array (
