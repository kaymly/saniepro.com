...
final class ThemesFlat_Addon_For_Elementor_janelas {
    ...
    public function init_widgets() {
        ...
        require_once( __DIR__ . '/widgets/widget-image-carousel.php' );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFImageCarousel_Widget() );
        ...
        require_once( __DIR__ . '/widgets/widget-category-services.php' );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFCategoryServices_Widget() );
        ...
        require_once( __DIR__ . '/widgets/widget-heading-section.php' );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFHeadingSection_Widget() );
    ...
    public function widget_styles() {
        ...
        wp_register_style( 'tf-image-carousel', plugins_url( '/assets/css/image-carousel/tf-image-carousel.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-category-service', plugins_url( '/assets/css/category-services/tf-category-services.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-project', plugins_url( '/assets/css/project/tf-project.css', __FILE__ ) );
    ...
    public function widget_scripts() {
        ...
        wp_register_script( 'tf-image-carousel', plugins_url( '/assets/js/image-carousel/tf-image-carousel.js', __FILE__ ), [ 'jquery' ], false, true );
    ...
    ========================================= */
        ...
        public static function get_template_id( $type ) {
            ...
            $tfhf_templates = ThemesFlat_Addon_For_Elementor_janelas::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
...
ThemesFlat_Addon_For_Elementor_janelas::instance();