    ...
    public function control_render( $control ) {
        ...
        switch ($control['type']) {
            ...
            case 'single-image-control':?>
                ...
                <h6 class="themesflat-options-control-title"><?php echo esc_html($title);?></h6>
                ...
                <div class="themesflat-options-control-field">
                    <?php foreach ( $choices as $_value => $params ): ?>
                        <label> 
                            ...
                            <span data-tooltip="<?php  echo esc_attr( $params['tooltip'] ) ?>">
                                <img src="<?php  echo esc_attr( $params['src'] ) ?>" alt="<?php  echo esc_attr( $_value ) ?>" />
                            </span>
                        </label>
                    <?php endforeach ;?>
                </div>
            ...
            case 'textarea': ?>
                <h6 class="themesflat-options-control-title"><?php echo esc_html($title);?></h6>
                <div class="themesflat-options-control-inputs">
                    <textarea name="<?php  echo esc_attr($name);?>" id="<?php  echo esc_attr( $control['id'] ) ?>"><?php echo esc_html( $value ) ?></textarea>
                </div>
                <?php 
            break;
            ...
            case 'color-picker': ?>
                ...
                <div class="background-color">
                    <div class="themesflat-options-control-color-picker">
                        <div class="themesflat-options-control-inputs">
                            <input type="text" class='alpha-color-control' data-show-opacity="true" data-palette="true" id="<?php  echo esc_attr( $name ) ?>-color" data-alpha="true" name="<?php  echo esc_attr($name);?>" data-default-color="" value="<?php  echo esc_attr( $value ) ?>" />
                        </div>
                    </div>
                </div>
                <?php 
