...
$wp_customize->add_control(
    ...
    array(
        ...
        'priority'  => 1,
        'label'     => esc_html__('Columns Footer', 'janelas'),
        'choices'   => array(                
            1     => esc_html__( '1 Columns', 'janelas' ),
            2     => esc_html__( '2 Columns', 'janelas' ),
            3     => esc_html__( '3 Columns', 'janelas' ),
            4     => esc_html__( '4 Columns ( 3 | 2 | 4 | 3 )', 'janelas' ),
            5     => esc_html__( '4 Columns ( 3 | 3 | 3 | 3 )', 'janelas' ),                  
        )
    )
); 
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'footer_controls',
    array(
        'label' => esc_html__( 'Footer Box Controls (px)', 'janelas' ),
        'section' => 'section_footer',
        'type' => 'box-controls',
        'priority' => 2
    ))
