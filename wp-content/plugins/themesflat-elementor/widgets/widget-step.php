	...
	protected function register_controls() {
		// Start List Setting        
			...
			$repeater->add_control(
				'button_link',
				[
					'label' => esc_html__( 'Button Link', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::TEXT,
			...
			$repeater->add_control(
				...
				[
					...
					'default' => [
						'value' => 'janelas-icon-001-solar-panels',
	    ...
	    // Start Style Style
			...
			$this->add_control(
				...
				[
					...
					'default' => '#ffffff',
					'selectors' => [
						'{{WRAPPER}} .tf-step.style3 .item-step .content' => 'background-color: {{VALUE}}',
					],
					'condition' => [
	                	'styles' => 'style3',
	                ],
			...
			$this->add_control(
				'content_bgcolor_hover_s3',
				[
					'label' => esc_html__( 'Background Color Hover', 'themesflat-elementor' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'default' => '#ff7029',
					'selectors' => [
						'{{WRAPPER}} .tf-step.style3 .item-step:hover .content' => 'background-color: {{VALUE}}',
					],
					'condition' => [
	                	'styles' => 'style3',
	                ],
		       				...
		       				<div class="content">
		       					...
		       					<div class="inner-content">
					       			...
					       			<div class="content-hide">
						       			<div class="text"><?php printf($step['text']); ?></div>
					       				<a href="<?php echo esc_attr($step['button_link']); ?>" class="button-step"><?php echo esc_attr($step['button_text']); ?><i class="janelas-icon-long-arrow-right"></i></a>
				       				</div>
				       			</div>
			       			</div>
		       			</div>
