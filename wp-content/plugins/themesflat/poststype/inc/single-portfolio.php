								...
								<div class="meta-post">
									<div class="inner-meta-post">
										<div class="meta-post-item meta-post-info">
											<h4 class="meta-post-title"><?php esc_html_e('Portfolio Infor','themesflat') ?></h4>
											<div class="meta-post-content"><?php the_field('portfolio_infor', get_the_ID()); ?></div>
										</div>

										<div class="meta-post-item meta-post-category">
											<h4 class="meta-post-title"><?php esc_html_e('Category','themesflat') ?></h4>
											<div class="meta-post-content"><?php echo esc_attr ( the_terms( get_the_ID(), 'portfolios_category', '', ', ', '' ) ); ?></div>
										</div>
